  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        festive: "bg-gradient-to-r from-primary to-secondary text-primary-foreground hover:-translate-y-0.5 hover:shadow-[0_8px_25px_hsl(25_95%_50%_/_0.4)]",
        gold: "bg-gradient-to-r from-accent to-[hsl(35,85%,45%)] text-foreground font-semibold hover:-translate-y-0.5 hover:shadow-[0_8px_25px_hsl(43_90%_55%_/_0.5)]",
        whatsapp: "bg-[#25D366] text-white hover:bg-[#128C7E] hover:-translate-y-0.5 hover:shadow-lg",
        hero: "bg-gradient-to-r from-accent to-[hsl(35,85%,45%)] text-foreground font-semibold text-base hover:-translate-y-1 hover:shadow-[0_10px_30px_hsl(43_90%_55%_/_0.5)]",
        "hero-outline": "border-2 border-accent bg-transparent text-accent hover:bg-accent hover:text-foreground font-semibold",
      },
      size: {
